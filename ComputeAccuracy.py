...
import os
import sys
caffe_root = '/home/n9346490/Quartet/caffe-master/'
...
if __name__ == '__main__':
    ...
    net = caffe.Net(netdir + 'deploy.prototxt',netdir + 'snapshot/_iter_10000.caffemodel',caffe.TEST)
